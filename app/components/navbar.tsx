...
export default function NavBar() {
  return (
    <header className='fixed top-8 left-1/2 transform -translate-x-1/2 z-1'>
      <nav>
        <ul className='flex border border-gray-400/25 rounded-full backdrop-blur-xs bg-gray-400/10'>
          ...
          <li className='hover:bg-gray-400/10 p-4 min-w-28 text-center rounded-full'><CustomLink href='/#education'>Education</CustomLink></li>
